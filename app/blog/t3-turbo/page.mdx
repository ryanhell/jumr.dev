...
export const metadata = mdHelper({
  title: "Challenges of Old City Operations",
  description:
    "Ever wondered what it takes to be a industry veteran workforce dealing with the oldest city in America? Come check it out.",
  date: "2022-08-22",
  updatedAt: "2022-12-03",
  previewImg: "/images/monkeybidness1.png",
  readingTime: 20,
  slug: "/t3-turbo",
});
